...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.tilemap/package.json`
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.tilemap/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.tilemap/Tests/Base/Package.Tests.asmdef`
