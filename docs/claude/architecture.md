...
├── Unity-Package/            # The package source — only `Packages/com.ivanmurzak.unity.mcp.tilemap/` ships
│   └── Assets/
...
> Anything outside `Unity-Package/Packages/com.ivanmurzak.unity.mcp.tilemap/` is NOT shipped to consumers.
...
- **Dependency:** `com.ivanmurzak.unity.mcp` v0.68.0 (declared in `Unity-Package/Packages/com.ivanmurzak.unity.mcp.tilemap/package.json`)
- **Assemblies (placeholders set by init.ps1):**
  - `com.IvanMurzak.Unity.MCP.Tilemap.Editor`
  - `com.IvanMurzak.Unity.MCP.Tilemap.Runtime`
  - `com.IvanMurzak.Unity.MCP.Tilemap.Editor.Tests`
  - `com.IvanMurzak.Unity.MCP.Tilemap.Tests`
...
- **Editor tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.tilemap/Editor`
  - Works in Edit Mode and Play Mode in the Editor.
  - Has access to Editor APIs.
  - NOT shipped in game builds.
- **Runtime tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.tilemap/Runtime`
  - Works in Edit Mode and Play Mode in the Editor.
...
renames directories, files, and replaces tokens like `com.IvanMurzak.Unity.MCP.Tilemap`,
`com.ivanmurzak.unity.mcp.tilemap`, `AI Tilemap`, `com.IvanMurzak/AI Tilemap Installer`,
`AI-Tilemap-Installer`. Keep these placeholder tokens consistent
...
`AI-Tilemap-Installer.unitypackage` via the build method
`com.IvanMurzak.Unity.MCP.Tilemap.Installer.PackageExporter.ExportPackage`, then attaches it
