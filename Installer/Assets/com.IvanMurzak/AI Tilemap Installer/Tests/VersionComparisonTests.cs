...
using com.IvanMurzak.Unity.MCP.Tilemap.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Tilemap.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Tilemap.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.tilemap";
