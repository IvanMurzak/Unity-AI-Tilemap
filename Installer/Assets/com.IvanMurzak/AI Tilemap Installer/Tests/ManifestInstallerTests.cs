...
namespace com.IvanMurzak.Unity.MCP.Tilemap.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Tilemap Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Tilemap Installer/Tests/Files";
