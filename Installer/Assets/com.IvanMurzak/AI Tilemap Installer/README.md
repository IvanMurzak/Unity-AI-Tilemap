...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.tilemap/package.json`
...
- 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.tilemap/Tests` folder
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.tilemap` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.tilemap` as well.
